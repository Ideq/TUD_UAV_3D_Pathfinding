...
figure = plt.figure(figsize=(6,5), facecolor='w')
...
ax.plot(x, y, z, c='b')
#ax.plot(x000, y000, z000, c='g')
#ax.plot(x001, y001, z001, c='y')
...
green=pl.lines.Line2D([0],[0],color="g",linewidth=2)
yellow=pl.lines.Line2D([0],[0],color="y",linewidth=2)
...
ax.legend([blue,green], ['calculated path','UAV movement'],fontsize = 20,loc=(0.1,0.75))
